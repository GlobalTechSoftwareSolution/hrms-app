...
class ApiService {
  ...
  Future<Map<String, String>> _getHeaders({bool includeAuth = true}) async {
    ...
    if (includeAuth) {
      ...
      if (token != null) {
        headers['Authorization'] = 'Bearer $token'; // or 'Token $token' for Django Token Auth
      }
    }
  ...
  Future<Map<String, dynamic>> getAttendance({String? employeeId, String? date}) async {
    try {
  ...
  Future<Map<String, dynamic>> createLeaveRequest(Map<String, dynamic> leaveData) async {
    try {
      final response = await http.post(
